...
>
  {isAudioOn ? <Volume2 className="w-6 h-6" /> : <VolumeX className="w-6 h-6" />}
        ...
        >
          <Link href="/register">
            <button
              className="w-44 bg-primary text-primary-foreground py-3 px-8 rounded font-orbitron font-bold uppercase tracking-wider hover:bg-opacity-90 transition-all duration-300 glow-btn text-lg"
            >
              Join Tournament
            </button>
          </Link>
          <Link href="/learn-more">
            <button 
              className="w-44 bg-transparent border-2 border-secondary text-secondary py-3 px-8 rounded font-orbitron font-bold uppercase tracking-wider hover:bg-secondary hover:bg-opacity-10 transition-all duration-300 glow-btn-cyan text-lg"
            >
              Learn More
            </button>
          </Link>
